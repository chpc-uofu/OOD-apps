...
local root = "/uufs/chpc.utah.edu/sys/installdir/rstudio-singularity/4.0.3"
-- local bin = pathJoin(root, "/bin")
local img = pathJoin(root, "ood-bioconductor_4.0.3.sif")
local library = pathJoin(root, "/library-ood-4.0")
local host_mnt = ""

local user_library = os.getenv("HOME") .. "/R/library-ood-bioconductor-4.0"
